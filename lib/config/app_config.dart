class AppConfig {
  ...
  static const String notificationApi = String.fromEnvironment('NOTIFICATION_API');
  ...
  static const String sevenCollegeAdmissionApi = String.fromEnvironment('SEVEN_COLLEGE_ADMISSION_API');
  ...
  static const String nursingAdmissionApi = String.fromEnvironment('NURSING_ADMISSION_API');
  static const String sevenCollegeMathApi = String.fromEnvironment('SEVEN_COLLEGE_MATH_API');
