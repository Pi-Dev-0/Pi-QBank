...
class Class4ReligionPage extends StatefulWidget {
  ...
  @override
  State<Class4ReligionPage> createState() => _Class4ReligionPageState();
}

class _Class4ReligionPageState extends State<Class4ReligionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Religion - Class 4'),
