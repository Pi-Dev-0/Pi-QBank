...
class Class4SciencePage extends StatefulWidget {
  const Class4SciencePage({super.key});

  @override
  State<Class4SciencePage> createState() => _Class4SciencePageState();
}

class _Class4SciencePageState extends State<Class4SciencePage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class4_science';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Science - Class 4'),
