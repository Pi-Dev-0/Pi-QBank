...
class Class4MathPage extends StatefulWidget {
  const Class4MathPage({super.key});

  @override
  State<Class4MathPage> createState() => _Class4MathPageState();
}

class _Class4MathPageState extends State<Class4MathPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class4_math';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Math - Class 4'),
