...
class Class4EnglishPage extends StatefulWidget {
  const Class4EnglishPage({super.key});

  @override
  State<Class4EnglishPage> createState() => _Class4EnglishPageState();
}

class _Class4EnglishPageState extends State<Class4EnglishPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class4_english';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'English - Class 4'),
