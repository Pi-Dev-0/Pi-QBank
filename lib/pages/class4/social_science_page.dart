...
class Class4SocialSciencePage extends StatefulWidget {
  const Class4SocialSciencePage({super.key});

  @override
  State<Class4SocialSciencePage> createState() =>
      _Class4SocialSciencePageState();
}

class _Class4SocialSciencePageState extends State<Class4SocialSciencePage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class4_social_science';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Social Science - Class 4'),
