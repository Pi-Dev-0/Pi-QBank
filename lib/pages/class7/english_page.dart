...
class Class7EnglishPage extends StatefulWidget {
  const Class7EnglishPage({super.key});

  @override
  State<Class7EnglishPage> createState() => _Class7EnglishPageState();
}

class _Class7EnglishPageState extends State<Class7EnglishPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class7_english';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'English - Class 7'),
