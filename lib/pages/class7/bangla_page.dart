...
class Class7BanglaPage extends StatefulWidget {
  const Class7BanglaPage({super.key});

  @override
  State<Class7BanglaPage> createState() => _Class7BanglaPageState();
}

class _Class7BanglaPageState extends State<Class7BanglaPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class7_bangla';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'বাংলা - Class 7'),
