...
class Class7IslamicStudiesPage extends StatefulWidget {
  const Class7IslamicStudiesPage({super.key});

  @override
  State<Class7IslamicStudiesPage> createState() => _Class7IslamicStudiesPageState();
}

class _Class7IslamicStudiesPageState extends State<Class7IslamicStudiesPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class7_islamic_studies';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ইসলাম শিক্ষা - Class 7'),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return QuestionPaperCard(
                                ...
                                category: 'Class 7 Islamic Studies',
                              );
                            },
                          ),
          ),
