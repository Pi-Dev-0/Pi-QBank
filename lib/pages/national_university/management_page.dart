...
class NuManagementPage extends StatefulWidget {
  const NuManagementPage({super.key});

  @override
  State<NuManagementPage> createState() => _NuManagementPageState();
}

class _NuManagementPageState extends State<NuManagementPage> {
