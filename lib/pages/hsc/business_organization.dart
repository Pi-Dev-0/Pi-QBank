...
class HSCBusinessOrganization extends StatefulWidget {
  const HSCBusinessOrganization({super.key});

  @override
  State<HSCBusinessOrganization> createState() => _HSCBusinessOrganizationState();
}

class _HSCBusinessOrganizationState extends State<HSCBusinessOrganization> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_business_organization';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'business_organization')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ব্যবসায় সংগঠন ও ব্যবস্থাপনা - HSC'),
