...
class HSCHistoryFirstPaper extends StatefulWidget {
  const HSCHistoryFirstPaper({super.key});

  @override
  State<HSCHistoryFirstPaper> createState() => _HSCHistoryFirstPaperState();
}

class _HSCHistoryFirstPaperState extends State<HSCHistoryFirstPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_history_first';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'history_first')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ইতিহাস ১ম পত্র - HSC'),
