...
class HSCGeographySecondPaper extends StatefulWidget {
  const HSCGeographySecondPaper({super.key});

  @override
  State<HSCGeographySecondPaper> createState() => _HSCGeographySecondPaperState();
}

class _HSCGeographySecondPaperState extends State<HSCGeographySecondPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_geography_second';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'geography_second')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ভূগোল ২য় পত্র - HSC'),
