...
class HSCEnglishFirstPaper extends StatefulWidget {
  const HSCEnglishFirstPaper({super.key});

  @override
  State<HSCEnglishFirstPaper> createState() => _HSCEnglishFirstPaperState();
}

class _HSCEnglishFirstPaperState extends State<HSCEnglishFirstPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_english_first';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString() == 'English1')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'English 1st Paper - HSC'),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: QuestionPaperCard(
                                  ...
                                  category: 'HSC English 1st Paper',
                                ),
                              );
                            },
                          ),
