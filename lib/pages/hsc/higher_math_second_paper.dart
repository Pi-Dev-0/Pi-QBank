...
class HSCHigherMathSecondPaper extends StatefulWidget {
  const HSCHigherMathSecondPaper({super.key});

  @override
  State<HSCHigherMathSecondPaper> createState() =>
      _HSCHigherMathSecondPaperState();
}

class _HSCHigherMathSecondPaperState extends State<HSCHigherMathSecondPaper> {
  String _selectedType = 'Board Question';
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_higher_math_second';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => paper['subject'].toString() == 'Hmath2')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'উচ্চতর গণিত ২য় পত্র - HSC'),
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: ['Board Question', 'Test'].map((type) {
                return Expanded(
                  child: Padding(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: QuestionPaperCard(
                                  ...
                                  category: 'HSC Higher Math 2nd Paper',
                                ),
                              );
                            },
                          ),
