...
class HSCBiologySecondPaper extends StatefulWidget {
  const HSCBiologySecondPaper({super.key});

  @override
  State<HSCBiologySecondPaper> createState() => _HSCBiologySecondPaperState();
}

class _HSCBiologySecondPaperState extends State<HSCBiologySecondPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_biology_second';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString() == 'Biology2')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'জীববিজ্ঞান ২য় পত্র - HSC'),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: QuestionPaperCard(
                                  ...
                                  category: 'HSC Biology 2nd Paper',
                                ),
                              );
                            },
                          ),
