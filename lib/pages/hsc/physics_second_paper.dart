...
class HSCPhysicsSecondPaper extends StatefulWidget {
  const HSCPhysicsSecondPaper({super.key});

  @override
  State<HSCPhysicsSecondPaper> createState() => _HSCPhysicsSecondPaperState();
}

class _HSCPhysicsSecondPaperState extends State<HSCPhysicsSecondPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_physics_second';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString() == 'Physics2')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'পদার্থবিজ্ঞান ২য় পত্র - HSC'),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: QuestionPaperCard(
                                  ...
                                  category: 'HSC Physics 2nd Paper',
                                ),
                              );
                            },
                          ),
