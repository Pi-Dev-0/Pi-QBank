...
class HSCAccountingFirstPaper extends StatefulWidget {
  const HSCAccountingFirstPaper({super.key});

  @override
  State<HSCAccountingFirstPaper> createState() => _HSCAccountingFirstPaperState();
}

class _HSCAccountingFirstPaperState extends State<HSCAccountingFirstPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_accounting_first';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'accounting_first')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'হিসাববিজ্ঞান ১ম পত্র - HSC'),
