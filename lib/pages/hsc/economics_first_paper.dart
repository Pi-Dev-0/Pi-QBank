...
class HSCEconomicsFirstPaper extends StatefulWidget {
  const HSCEconomicsFirstPaper({super.key});

  @override
  State<HSCEconomicsFirstPaper> createState() => _HSCEconomicsFirstPaperState();
}

class _HSCEconomicsFirstPaperState extends State<HSCEconomicsFirstPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_economics_first';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'economics_first')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'অর্থনীতি ১ম পত্র - HSC'),
