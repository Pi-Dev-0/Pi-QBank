...
class HSCBanglaSecondPaper extends StatefulWidget {
  const HSCBanglaSecondPaper({super.key});

  @override
  State<HSCBanglaSecondPaper> createState() => _HSCBanglaSecondPaperState();
}

class _HSCBanglaSecondPaperState extends State<HSCBanglaSecondPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_bangla_second';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString() == 'Bangla2')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'বাংলা ২য় পত্র - HSC'),
