...
class HSCBusinessOrgFirstPaper extends StatefulWidget {
  const HSCBusinessOrgFirstPaper({super.key});

  @override
  State<HSCBusinessOrgFirstPaper> createState() => _HSCBusinessOrgFirstPaperState();
}

class _HSCBusinessOrgFirstPaperState extends State<HSCBusinessOrgFirstPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_business_org_first';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'business_org_first')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ব্যবসায় সংগঠন ১ম পত্র - HSC'),
