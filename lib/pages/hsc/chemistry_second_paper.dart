...
class HSCChemistrySecondPaper extends StatefulWidget {
  const HSCChemistrySecondPaper({super.key});

  @override
  State<HSCChemistrySecondPaper> createState() => _HSCChemistrySecondPaperState();
}

class _HSCChemistrySecondPaperState extends State<HSCChemistrySecondPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_chemistry_second';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString() == 'Chemistry2')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'রসায়ন ২য় পত্র - HSC'),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: QuestionPaperCard(
                                  ...
                                  category: 'HSC Chemistry 2nd Paper',
                                ),
                              );
                            },
                          ),
