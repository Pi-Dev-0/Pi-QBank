...
class HSCEconomicsSecondPaper extends StatefulWidget {
  const HSCEconomicsSecondPaper({super.key});

  @override
  State<HSCEconomicsSecondPaper> createState() => _HSCEconomicsSecondPaperState();
}

class _HSCEconomicsSecondPaperState extends State<HSCEconomicsSecondPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_economics_second';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'economics_second')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'অর্থনীতি ২য় পত্র - HSC'),
