...
class HSCPhysicsFirstPaper extends StatefulWidget {
  const HSCPhysicsFirstPaper({super.key});

  @override
  State<HSCPhysicsFirstPaper> createState() => _HSCPhysicsFirstPaperState();
}

class _HSCPhysicsFirstPaperState extends State<HSCPhysicsFirstPaper> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'পদার্থবিজ্ঞান ১ম পত্র - HSC'),
