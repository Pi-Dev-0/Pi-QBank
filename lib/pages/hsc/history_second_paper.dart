...
class HSCHistorySecondPaper extends StatefulWidget {
  const HSCHistorySecondPaper({super.key});

  @override
  State<HSCHistorySecondPaper> createState() => _HSCHistorySecondPaperState();
}

class _HSCHistorySecondPaperState extends State<HSCHistorySecondPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_history_second';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'history_second')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ইতিহাস ২য় পত্র - HSC'),
