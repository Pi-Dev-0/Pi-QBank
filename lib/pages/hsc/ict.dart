...
class HSCICT extends StatefulWidget {
  const HSCICT({super.key});

  @override
  State<HSCICT> createState() => _HSCICTState();
}

class _HSCICTState extends State<HSCICT> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'তথ্য ও যোগাযোগ প্রযুক্তি - HSC'),
