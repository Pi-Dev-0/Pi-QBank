...
class HSCChemistryFirstPaper extends StatefulWidget {
  const HSCChemistryFirstPaper({super.key});

  @override
  State<HSCChemistryFirstPaper> createState() => _HSCChemistryFirstPaperState();
}

class _HSCChemistryFirstPaperState extends State<HSCChemistryFirstPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_chemistry_first';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString() == 'Chemistry1')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'রসায়ন ১ম পত্র - HSC'),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: QuestionPaperCard(
                                  ...
                                  category: 'HSC Chemistry 1st Paper',
                                ),
                              );
                            },
                          ),
