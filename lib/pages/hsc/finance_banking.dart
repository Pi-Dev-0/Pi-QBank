...
class HSCFinanceBanking extends StatefulWidget {
  const HSCFinanceBanking({super.key});

  @override
  State<HSCFinanceBanking> createState() => _HSCFinanceBankingState();
}

class _HSCFinanceBankingState extends State<HSCFinanceBanking> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_finance_banking';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'finance_banking')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ফিন্যান্স ও ব্যাংকিং - HSC'),
