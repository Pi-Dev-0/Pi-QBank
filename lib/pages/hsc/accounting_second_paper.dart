...
class HSCAccountingSecondPaper extends StatefulWidget {
  const HSCAccountingSecondPaper({super.key});

  @override
  State<HSCAccountingSecondPaper> createState() => _HSCAccountingSecondPaperState();
}

class _HSCAccountingSecondPaperState extends State<HSCAccountingSecondPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_accounting_second';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'accounting_second')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'হিসাববিজ্ঞান ২য় পত্র - HSC'),
