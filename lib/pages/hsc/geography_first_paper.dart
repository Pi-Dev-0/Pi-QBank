...
class HSCGeographyFirstPaper extends StatefulWidget {
  const HSCGeographyFirstPaper({super.key});

  @override
  State<HSCGeographyFirstPaper> createState() => _HSCGeographyFirstPaperState();
}

class _HSCGeographyFirstPaperState extends State<HSCGeographyFirstPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_geography_first';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'geography_first')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ভূগোল ১ম পত্র - HSC'),
