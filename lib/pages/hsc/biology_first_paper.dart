...
class HSCBiologyFirstPaper extends StatefulWidget {
  const HSCBiologyFirstPaper({super.key});

  @override
  State<HSCBiologyFirstPaper> createState() => _HSCBiologyFirstPaperState();
}

class _HSCBiologyFirstPaperState extends State<HSCBiologyFirstPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_biology_first';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString() == 'Biology1')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'জীববিজ্ঞান ১ম পত্র - HSC'),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: QuestionPaperCard(
                                  ...
                                  category: 'HSC Biology 1st Paper',
                                ),
                              );
                            },
                          ),
