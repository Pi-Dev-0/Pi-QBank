...
class HSCEnglishSecondPaper extends StatefulWidget {
  const HSCEnglishSecondPaper({super.key});

  @override
  State<HSCEnglishSecondPaper> createState() => _HSCEnglishSecondPaperState();
}

class _HSCEnglishSecondPaperState extends State<HSCEnglishSecondPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_english_second';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString() == 'English2')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'English 2nd Paper - HSC'),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: QuestionPaperCard(
                                  ...
                                  category: 'HSC English 2nd Paper',
                                ),
                              );
                            },
                          ),
