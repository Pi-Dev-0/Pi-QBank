...
class HSCHigherMathFirstPaper extends StatefulWidget {
  const HSCHigherMathFirstPaper({super.key});

  @override
  State<HSCHigherMathFirstPaper> createState() =>
      _HSCHigherMathFirstPaperState();
}

class _HSCHigherMathFirstPaperState extends State<HSCHigherMathFirstPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'hsc_higher_math_first';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => paper['subject'].toString() == 'Hmath1')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'উচ্চতর গণিত ১ম পত্র - HSC'),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: QuestionPaperCard(
                                  ...
                                  category: 'HSC Higher Math 1st Paper',
                                ),
                              );
                            },
                          ),
