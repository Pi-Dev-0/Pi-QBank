...
class Class3MathPage extends StatefulWidget {
  const Class3MathPage({super.key});

  @override
  State<Class3MathPage> createState() => _Class3MathPageState();
}

class _Class3MathPageState extends State<Class3MathPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class3_math';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Math - Class 3'),
