...
class Class3SciencePage extends StatefulWidget {
  const Class3SciencePage({super.key});

  @override
  State<Class3SciencePage> createState() => _Class3SciencePageState();
}

class _Class3SciencePageState extends State<Class3SciencePage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class3_science';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Science - Class 3'),
