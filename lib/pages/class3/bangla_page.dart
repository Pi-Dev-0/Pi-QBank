...
class Class3BanglaPage extends StatefulWidget {
  const Class3BanglaPage({super.key});

  @override
  State<Class3BanglaPage> createState() => _Class3BanglaPageState();
}

class _Class3BanglaPageState extends State<Class3BanglaPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class3_bangla';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'বাংলা - Class 3'),
