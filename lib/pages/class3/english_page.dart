...
class Class3EnglishPage extends StatefulWidget {
  ...
  @override
  State<Class3EnglishPage> createState() => _Class3EnglishPageState();
}

class _Class3EnglishPageState extends State<Class3EnglishPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'English - Class 3'),
