...
class Class2EnglishPage extends StatefulWidget {
  const Class2EnglishPage({super.key});

  @override
  State<Class2EnglishPage> createState() => _Class2EnglishPageState();
}

class _Class2EnglishPageState extends State<Class2EnglishPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class2_english';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'English - Class 2'),
