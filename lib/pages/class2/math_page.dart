...
class Class2MathPage extends StatefulWidget {
  const Class2MathPage({super.key});

  @override
  State<Class2MathPage> createState() => _Class2MathPageState();
}

class _Class2MathPageState extends State<Class2MathPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class2_math';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Math - Class 2'),
