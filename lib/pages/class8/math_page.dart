...
class Class8MathPage extends StatefulWidget {
  const Class8MathPage({super.key});

  @override
  State<Class8MathPage> createState() => _Class8MathPageState();
}

class _Class8MathPageState extends State<Class8MathPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class8_math';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'গণিত - Class 8'),
