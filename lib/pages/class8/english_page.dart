...
class Class8EnglishPage extends StatefulWidget {
  const Class8EnglishPage({super.key});

  @override
  State<Class8EnglishPage> createState() => _Class8EnglishPageState();
}

class _Class8EnglishPageState extends State<Class8EnglishPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class8_english';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'English - Class 8'),
