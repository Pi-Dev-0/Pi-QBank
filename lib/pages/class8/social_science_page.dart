...
class Class8SocialSciencePage extends StatefulWidget {
  const Class8SocialSciencePage({super.key});

  @override
  State<Class8SocialSciencePage> createState() => _Class8SocialSciencePageState();
}

class _Class8SocialSciencePageState extends State<Class8SocialSciencePage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class8_social_science';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'social_science')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ইতিহাস ও সামাজিক বিজ্ঞান - Class 8'),
