...
class Class8SciencePage extends StatefulWidget {
  const Class8SciencePage({super.key});

  @override
  State<Class8SciencePage> createState() => _Class8SciencePageState();
}

class _Class8SciencePageState extends State<Class8SciencePage> {
