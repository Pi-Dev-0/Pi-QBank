...
class Class8ScienceInquiryPage extends StatefulWidget {
  const Class8ScienceInquiryPage({super.key});

  @override
  State<Class8ScienceInquiryPage> createState() => _Class8SciencePageState();
}

class _Class8SciencePageState extends State<Class8ScienceInquiryPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class8_science';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) =>
                    paper['subject'].toString().toLowerCase() == 'science')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'বিজ্ঞান - Class 8'),
