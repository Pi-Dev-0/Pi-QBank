...
class Class8IslamicStudiesPage extends StatefulWidget {
  const Class8IslamicStudiesPage({super.key});

  @override
  State<Class8IslamicStudiesPage> createState() => _Class8IslamicStudiesPageState();
}

class _Class8IslamicStudiesPageState extends State<Class8IslamicStudiesPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    final String scriptUrl = AppConfig.class8Api;
    const String cacheKey = 'class8_islamic_studies';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ইসলাম শিক্ষা - Class 8'),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return QuestionPaperCard(
                                ...
                                category: 'Class 8 Islamic Studies',
                              );
                            },
                          ),
          ),
