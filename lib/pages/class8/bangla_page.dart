...
class Class8BanglaPage extends StatefulWidget {
  const Class8BanglaPage({super.key});

  @override
  State<Class8BanglaPage> createState() => _Class8BanglaPageState();
}

class _Class8BanglaPageState extends State<Class8BanglaPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class8_bangla';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'বাংলা - Class 8'),
