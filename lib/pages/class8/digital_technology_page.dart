...
class Class8DigitalTechnologyPage extends StatefulWidget {
  const Class8DigitalTechnologyPage({super.key});

  @override
  State<Class8DigitalTechnologyPage> createState() => _Class8DigitalTechnologyPageState();
}

class _Class8DigitalTechnologyPageState extends State<Class8DigitalTechnologyPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class8_digital_technology';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ডিজিটাল প্রযুক্তি - Class 8'),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return QuestionPaperCard(
                                ...
                                category: 'Class 8 Digital Technology',
                              );
                            },
                          ),
          ),
