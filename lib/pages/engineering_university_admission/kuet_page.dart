...
class KUETPage extends StatefulWidget {
  const KUETPage({super.key});

  @override
  State<KUETPage> createState() => _KUETPageState();
}

class _KUETPageState extends State<KUETPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'kuet_papers';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'KUET'),
