...
class CUETPage extends StatefulWidget {
  ...
  @override
  State<CUETPage> createState() => _CUETPageState();
}

class _CUETPageState extends State<CUETPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'cuet_papers';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'CUET'),
