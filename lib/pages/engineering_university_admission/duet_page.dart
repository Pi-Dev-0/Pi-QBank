...
class DUETPage extends StatefulWidget {
  const DUETPage({super.key});

  @override
  State<DUETPage> createState() => _DUETPageState();
}

class _DUETPageState extends State<DUETPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'duet_papers';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'DUET'),
