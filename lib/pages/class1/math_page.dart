...
class Class1MathPage extends StatefulWidget {
  ...
  @override
  State<Class1MathPage> createState() => _Class1MathPageState();
}

class _Class1MathPageState extends State<Class1MathPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class1_math';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Math - Class 1'),
