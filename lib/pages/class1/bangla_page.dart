...
class Class1BanglaPage extends StatefulWidget {
  ...
  @override
  State<Class1BanglaPage> createState() => _Class1BanglaPageState();
}

class _Class1BanglaPageState extends State<Class1BanglaPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class1_bangla';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'বাংলা - Class 1'),
