...
class Class5BanglaPage extends StatefulWidget {
  ...
  @override
  State<Class5BanglaPage> createState() => _Class5BanglaPageState();
}

class _Class5BanglaPageState extends State<Class5BanglaPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'বাংলা - Class 5'),
