...
class Class5MathPage extends StatefulWidget {
  const Class5MathPage({super.key});

  @override
  State<Class5MathPage> createState() => _Class5MathPageState();
}

class _Class5MathPageState extends State<Class5MathPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class5_math';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Math - Class 5'),
