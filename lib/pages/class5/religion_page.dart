...
class Class5ReligionPage extends StatefulWidget {
  ...
  @override
  State<Class5ReligionPage> createState() => _Class5ReligionPageState();
}

class _Class5ReligionPageState extends State<Class5ReligionPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class5_religion';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Religion - Class 5'),
