...
class Class5SciencePage extends StatefulWidget {
  const Class5SciencePage({super.key});

  @override
  State<Class5SciencePage> createState() => _Class5SciencePageState();
}

class _Class5SciencePageState extends State<Class5SciencePage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class5_science';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Science - Class 5'),
