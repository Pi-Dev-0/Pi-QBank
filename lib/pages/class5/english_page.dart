...
class Class5EnglishPage extends StatefulWidget {
  const Class5EnglishPage({super.key});

  @override
  State<Class5EnglishPage> createState() => _Class5EnglishPageState();
}

class _Class5EnglishPageState extends State<Class5EnglishPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class5_english';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'English - Class 5'),
