...
class Class6EnglishPage extends StatefulWidget {
  const Class6EnglishPage({super.key});

  @override
  State<Class6EnglishPage> createState() => _Class6EnglishPageState();
}

class _Class6EnglishPageState extends State<Class6EnglishPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class6_english';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'English - Class 6'),
