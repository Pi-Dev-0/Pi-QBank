...
class Class6DigitalTechnologyPage extends StatefulWidget {
  const Class6DigitalTechnologyPage({super.key});

  @override
  State<Class6DigitalTechnologyPage> createState() => _Class6DigitalTechnologyPageState();
}

class _Class6DigitalTechnologyPageState extends State<Class6DigitalTechnologyPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class6_digital_technology';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ডিজিটাল প্রযুক্তি - Class 6'),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return QuestionPaperCard(
                                ...
                                category: 'Class 6 Digital Technology',
                              );
                            },
                          ),
          ),
