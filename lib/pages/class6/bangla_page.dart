...
class Class6BanglaPage extends StatefulWidget {
  const Class6BanglaPage({super.key});

  @override
  State<Class6BanglaPage> createState() => _Class6BanglaPageState();
}

class _Class6BanglaPageState extends State<Class6BanglaPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class6_bangla';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'বাংলা - Class 6'),
