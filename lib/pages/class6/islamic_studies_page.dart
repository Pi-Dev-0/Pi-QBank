...
class Class6IslamicStudiesPage extends StatefulWidget {
  const Class6IslamicStudiesPage({super.key});

  @override
  State<Class6IslamicStudiesPage> createState() => _Class6IslamicStudiesPageState();
}

class _Class6IslamicStudiesPageState extends State<Class6IslamicStudiesPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class6_islamic_studies';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'islamic_studies')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ইসলাম শিক্ষা - Class 6'),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return QuestionPaperCard(
                                ...
                                category: 'Class 6 Islamic Studies',
                              );
                            },
                          ),
          ),
