...
class Class6SciencePage extends StatefulWidget {
  const Class6SciencePage({super.key});

  @override
  State<Class6SciencePage> createState() => _Class6SciencePageState();
}

class _Class6SciencePageState extends State<Class6SciencePage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class6_science';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'বিজ্ঞান - Class 6'),
