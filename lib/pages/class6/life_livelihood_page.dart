...
class Class6LifeLivelihoodPage extends StatefulWidget {
  const Class6LifeLivelihoodPage({super.key});

  @override
  State<Class6LifeLivelihoodPage> createState() => _Class6LifeLivelihoodPageState();
}

class _Class6LifeLivelihoodPageState extends State<Class6LifeLivelihoodPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class6_life_livelihood';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'life_livelihood')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'জীবন ও জীবিকা - Class 6'),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return QuestionPaperCard(
                                ...
                                category: 'Class 6 Life and Livelihood',
                              );
                            },
                          ),
          ),
