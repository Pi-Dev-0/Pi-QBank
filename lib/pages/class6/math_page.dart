...
class Class6MathPage extends StatefulWidget {
  const Class6MathPage({super.key});

  @override
  State<Class6MathPage> createState() => _Class6MathPageState();
}

class _Class6MathPageState extends State<Class6MathPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class6_math';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'Math - Class 6'),
