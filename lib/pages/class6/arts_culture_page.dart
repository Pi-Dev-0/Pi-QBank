...
class Class6ArtsCulturePage extends StatefulWidget {
  const Class6ArtsCulturePage({super.key});

  @override
  State<Class6ArtsCulturePage> createState() => _Class6ArtsCulturePageState();
}

class _Class6ArtsCulturePageState extends State<Class6ArtsCulturePage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class6_arts_culture';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'arts_culture')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'শিল্প ও সংস্কৃতি - Class 6'),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return QuestionPaperCard(
                                ...
                                category: 'Class 6 Arts and Culture',
                              );
                            },
                          ),
          ),
