...
class Class6SocialSciencePage extends StatefulWidget {
  const Class6SocialSciencePage({super.key});

  @override
  State<Class6SocialSciencePage> createState() => _Class6SocialSciencePageState();
}

class _Class6SocialSciencePageState extends State<Class6SocialSciencePage> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'class6_social_science';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ইতিহাস ও সামাজিক বিজ্ঞান - Class 6'),
