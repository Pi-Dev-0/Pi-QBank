...
class Class6HealthProtectionPage extends StatefulWidget {
  const Class6HealthProtectionPage({super.key});

  @override
  State<Class6HealthProtectionPage> createState() => _Class6HealthProtectionPageState();
}

class _Class6HealthProtectionPageState extends State<Class6HealthProtectionPage> {
  ...
  Future<void> fetchQuestionPapers() async {
    final String scriptUrl = AppConfig.class6Api;
    const String cacheKey = 'class6_health_protection';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) => 
                    paper['subject'].toString().toLowerCase() == 'health_protection')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'স্বাস্থ্য সুরক্ষা - Class 6'),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return QuestionPaperCard(
                                ...
                                category: 'Class 6 Health Protection',
                              );
                            },
                          ),
          ),
