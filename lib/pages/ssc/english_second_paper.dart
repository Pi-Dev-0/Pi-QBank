...
class SSCEnglishSecondPaper extends StatefulWidget {
  const SSCEnglishSecondPaper({super.key});

  @override
  State<SSCEnglishSecondPaper> createState() => _SSCEnglishSecondPaperState();
}

class _SSCEnglishSecondPaperState extends State<SSCEnglishSecondPaper> {
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            final filteredPapers = (data['papers'] as List)
                .where((paper) => paper['subject'] == 'English2')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return ConnectivityWrapper(
      child: Scaffold(
        appBar: const CustomAppBar(title: 'English Second Paper - SSC'),
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return QuestionPaperCard(
                                  ...
                                  category: 'SSC English Second Paper',
                                );
                              },
                            ),
            ),
