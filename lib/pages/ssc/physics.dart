...
class SSCPhysics extends StatefulWidget {
  const SSCPhysics({super.key});

  @override
  State<SSCPhysics> createState() => _SSCPhysicsState();
}

class _SSCPhysicsState extends State<SSCPhysics> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'ssc_physics';
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            final filteredPapers = (data['papers'] as List)
                .where((paper) => paper['subject'] == 'Physics')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'পদার্থবিজ্ঞান - SSC'),
