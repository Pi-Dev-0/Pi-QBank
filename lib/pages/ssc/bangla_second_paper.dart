...
class SSCBanglaSecondPaper extends StatefulWidget {
  const SSCBanglaSecondPaper({super.key});

  @override
  State<SSCBanglaSecondPaper> createState() => _SSCBanglaSecondPaperState();
}

class _SSCBanglaSecondPaperState extends State<SSCBanglaSecondPaper> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'ssc_bangla_second';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'বাংলা ২য় পত্র - SSC'),
