...
class SSCReligion extends StatefulWidget {
  const SSCReligion({super.key});

  @override
  State<SSCReligion> createState() => _SSCReligionState();
}

class _SSCReligionState extends State<SSCReligion> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'ssc_religion';
  ...
  Widget build(BuildContext context) {
    ...
    return ConnectivityWrapper(
      child: Scaffold(
        appBar: const CustomAppBar(title: 'ধর্ম ও নৈতিক শিক্ষা - SSC'),
