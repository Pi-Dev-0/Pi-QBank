...
class SSCGeography extends StatefulWidget {
  const SSCGeography({super.key});

  @override
  State<SSCGeography> createState() => _SSCGeographyState();
}

class _SSCGeographyState extends State<SSCGeography> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'ssc_geography';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'ভূগোল - SSC'),
