...
class SSCBangladeshGlobalStudies extends StatefulWidget {
  const SSCBangladeshGlobalStudies({super.key});

  @override
  State<SSCBangladeshGlobalStudies> createState() =>
      _SSCBangladeshGlobalStudiesState();
}

class _SSCBangladeshGlobalStudiesState
    extends State<SSCBangladeshGlobalStudies> {
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            final filteredPapers = (data['papers'] as List)
                .where((paper) =>
                    paper['subject'].toString().toLowerCase() == 'bangladesh and global studies')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'বাংলাদেশ ও বিশ্ব পরিচয় - SSC'),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return QuestionPaperCard(
                                ...
                                category: 'SSC Bangladesh and Global Studies',
                              );
                            },
                          ),
          ),
