...
class SSCMathematics extends StatefulWidget {
  const SSCMathematics({super.key});

  @override
  State<SSCMathematics> createState() => _SSCMathematicsState();
}

class _SSCMathematicsState extends State<SSCMathematics> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'ssc_mathematics';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'গণিত - SSC'),
