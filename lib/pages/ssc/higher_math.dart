...
class SSCHigherMath extends StatefulWidget {
  const SSCHigherMath({super.key});

  @override
  State<SSCHigherMath> createState() => _SSCHigherMathState();
}

class _SSCHigherMathState extends State<SSCHigherMath> {
  ...
  Future<void> fetchQuestionPapers() async {
    ...
    const String cacheKey = 'ssc_higher_math';
  ...
  Widget build(BuildContext context) {
    ...
    return ConnectivityWrapper(
      child: Scaffold(
        appBar: const CustomAppBar(title: 'উচ্চতর গণিত - SSC'),
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return QuestionPaperCard(
                                  ...
                                  category: 'SSC Higher Mathematics',
                                );
                              },
                            ),
            ),
