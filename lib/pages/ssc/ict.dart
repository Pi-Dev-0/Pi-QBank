...
class SSCICT extends StatefulWidget {
  const SSCICT({super.key});

  @override
  State<SSCICT> createState() => _SSCICTState();
}

class _SSCICTState extends State<SSCICT> {
        ...
        () async {
          ...
          if (response.statusCode == 200) {
            ...
            return (data['papers'] as List)
                .where((paper) =>
                    paper['subject'].toString().toLowerCase() == 'ict')
                .map((paper) => {
                      'title': paper['title'],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'তথ্য ও যোগাযোগ প্রযুক্তি - SSC'),
