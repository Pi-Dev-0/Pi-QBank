...
class SSCBanglaFirstPaper extends StatefulWidget {
  const SSCBanglaFirstPaper({super.key});

  @override
  State<SSCBanglaFirstPaper> createState() => _SSCBanglaFirstPaperState();
}

class _SSCBanglaFirstPaperState extends State<SSCBanglaFirstPaper> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: 'বাংলা ১ম পত্র - SSC'),
